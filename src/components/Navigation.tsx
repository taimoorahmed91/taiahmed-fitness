...
import { Dumbbell, LayoutDashboard, Utensils, LogOut, User, Scale, Moon, BarChart3, Menu, Calendar, ArrowLeftRight, UserCheck, Ruler, MessageCircle, RefreshCw, FileText, Trophy } from 'lucide-react';
